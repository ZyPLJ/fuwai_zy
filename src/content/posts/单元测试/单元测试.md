---
title: C#中进行单元测试
published: 2024-06-25 23:42:55
description: 单元测试前言时隔多个月，终于抽空学习了点新知识，那么这次来记录一下C#怎么进行单元测试，单元测试是做什么的。我相信大部分刚毕业的都很疑惑单元测试是干什么的？在小厂实习了6个月后，我发现每天除了写CRUD就是写CRUD，几乎用不到单元测试。写完一个功能直接上手去测，当然这只是我个人感受，仅供参考。然后当我还在抱怨测试好烦的时候，大佬跟我说为什么不用单元测试和集成测试，我这也是有苦说不出。
tags: [C#, .NET]
category: .NET 技术合集
draft: false
pinned: false
...
- [Asp-Net-Core学习笔记：单元测试和集成测试 - 程序设计实验室 - 博客园 (cnblogs.com)](https://www.cnblogs.com/deali/p/17559685.html) https://www.cnblogs.com/deali/p/17559685.html